...
func (a *CoreDB) GetWebrootContext(ctx context.Context, webrootID string) (*WebrootContext, error) {
	...
	err := a.db.QueryRow(ctx,
		`SELECT w.id, w.tenant_id, w.name, w.runtime, w.runtime_version, w.runtime_config, w.public_folder, w.env_file_name, w.service_hostname_enabled, w.status, w.status_message, w.suspend_reason, w.created_at, w.updated_at,
...
func (a *CoreDB) GetFQDNContext(ctx context.Context, fqdnID string) (*FQDNContext, error) {
	...
	err := a.db.QueryRow(ctx,
		`SELECT f.id, f.fqdn, f.webroot_id, f.ssl_enabled, f.status, f.status_message, f.created_at, f.updated_at,
		        w.id, w.tenant_id, w.name, w.runtime, w.runtime_version, w.runtime_config, w.public_folder, w.env_file_name, w.service_hostname_enabled, w.status, w.status_message, w.suspend_reason, w.created_at, w.updated_at,
		        t.id, t.name, t.brand_id, t.region_id, t.cluster_id, t.shard_id, t.uid, t.sftp_enabled, t.ssh_enabled, t.disk_quota_bytes, t.status, t.status_message, t.suspend_reason, t.created_at, t.updated_at,
		        b.base_hostname
		 FROM fqdns f
...
func (a *CoreDB) GetCronJobContext(ctx context.Context, cronJobID string) (*CronJobContext, error) {
	...
	err := a.db.QueryRow(ctx,
		`SELECT c.id, c.tenant_id, c.webroot_id, c.name, c.schedule, c.command, c.working_directory, c.enabled, c.timeout_seconds, c.max_memory_mb, c.status, c.status_message, c.created_at, c.updated_at,
		        w.id, w.tenant_id, w.name, w.runtime, w.runtime_version, w.runtime_config, w.public_folder, w.env_file_name, w.status, w.status_message, w.suspend_reason, w.created_at, w.updated_at,
		        t.id, t.name, t.brand_id, t.region_id, t.cluster_id, t.shard_id, t.uid, t.sftp_enabled, t.ssh_enabled, t.disk_quota_bytes, t.status, t.status_message, t.suspend_reason, t.created_at, t.updated_at
		 FROM cron_jobs c
		...
		&cc.Webroot.ID, &cc.Webroot.TenantID, &cc.Webroot.Name, &cc.Webroot.Runtime, &cc.Webroot.RuntimeVersion, &cc.Webroot.RuntimeConfig, &cc.Webroot.PublicFolder, &cc.Webroot.EnvFileName, &cc.Webroot.Status, &cc.Webroot.StatusMessage, &cc.Webroot.SuspendReason, &cc.Webroot.CreatedAt, &cc.Webroot.UpdatedAt,
...
func (a *CoreDB) GetDaemonContext(ctx context.Context, daemonID string) (*DaemonContext, error) {
	...
	err := a.db.QueryRow(ctx,
		...
		&dc.Webroot.ID, &dc.Webroot.TenantID, &dc.Webroot.Name, &dc.Webroot.Runtime, &dc.Webroot.RuntimeVersion, &dc.Webroot.RuntimeConfig, &dc.Webroot.PublicFolder, &dc.Webroot.EnvFileName, &dc.Webroot.Status, &dc.Webroot.StatusMessage, &dc.Webroot.SuspendReason, &dc.Webroot.CreatedAt, &dc.Webroot.UpdatedAt,
