...
export function ValkeyPage() {
  ...
  return (
    <div className="space-y-6">
      <ResourceHeader title="Valkey Instances" subtitle="Valkey instances are managed per tenant. Click a tenant to view its instances." />

      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        <StatsCard label="Total Valkey Instances" value={stats?.valkey_instances ?? 0} icon={Boxes} />
