...
export function DatabasesPage() {
  ...
  return (
    <div className="space-y-6">
      <ResourceHeader title="Databases" subtitle="Databases are managed per tenant. Click a tenant to view its databases." />

      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        <StatsCard label="Total Databases" value={stats?.databases ?? 0} icon={Database} />
